          ...
          >
            ...
            >
              ...
              >
                ...
                <!-- Game picker (for game-related types) -->
                <div
                  v-if="
...
// Fetch all games for the picker
...
async function save() {
  ...
  try {
    ...
    saveMessage.value = t("account.showcase.saved");
    setTimeout(() => {
      saveMessage.value = "";
    }, 3000);
  } finally {
...
useHead({ title: t("account.showcase.title") });
</script>
